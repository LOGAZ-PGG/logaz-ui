...
type BrandColor = 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info';

/**
 * LOGAZ Typography Tokens
 */
declare const fonts: {
    readonly sans: readonly ["Montserrat", "sans-serif"];
    readonly syncopate: readonly ["Syncopate", "sans-serif"];
    readonly montserrat: readonly ["Montserrat", "sans-serif"];
    readonly roboto: readonly ["Roboto", "sans-serif"];
};
...
declare const DataPagination: React$1.ForwardRefExoticComponent<DataPaginationProps & React$1.RefAttributes<HTMLDivElement>>;
